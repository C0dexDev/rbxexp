...
local function HEAJGNA_fake_script() -- MainFrame.DragHandler 
...
coroutine.wrap(HEAJGNA_fake_script)()
local function GORDBPR_fake_script() -- MainFrame.MainHandler 
	local script = Instance.new('LocalScript', MainFrame)
...
coroutine.wrap(GORDBPR_fake_script)()
